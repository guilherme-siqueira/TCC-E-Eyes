...
\begin{itemize}
	...
	\item Taxa de uso da API: Do lado do aplicativo, é indispensável buscar maneiras de não repassar ao usuário o valor que é cobrado pela utilização da API, quando o limite é ultrapassado. Uma possibilidade seria a inserção de propaganda como um modo de compensar essa cobrança.
