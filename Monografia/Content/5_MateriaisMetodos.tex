...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{./Resources/sensor.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{./Resources/bluetooth.jpg}
	\captionof{figure}{Módulo BlueTooth HC-05.}
	\caption*{Fonte: www.filipeflop.com}
	\label{PhotoBlueTooth}
\end{figure}

Para a comunicação entre o Arduíno e o smartphone haviam diversas possibilidades de implementação. A troca de dados pela internet já seria utilizada pela aplicação Android para o reconhecimento de imagens, que será apresentado com mais detalhes na seção Métodos. No entanto, havia soluções mais simples, como por exemplo, a comunicação via Bluetooth, adotada pelo projeto. Assim como o sensor, foi inserido ao circuito controlado pelo Arduíno o módulo Bluetooth HC-05, apresentado pela figura \ref{PhotoBlueTooth}.

\subsection{Caixa do circuito}

Para fins de demonstração do protótipo, foi criado uma caixa para envolver o circuito. Para tanto foi utilizado uma garrafa PET de 2L, tesoura, fita adesiva transparente, fita isolante, um interruptor tipo navio de dois pinos e uma bateria de 9V.
