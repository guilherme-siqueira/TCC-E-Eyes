...
A segunda funcionalidade solicitaria essa e outras informações ao Cloud Vision, que são: textos, faces, rótulos e pontos turísticos. Por fim, ambas alternativas de extração de informação de imagens foram inseridas nos dois botões superiores do menu principal.
