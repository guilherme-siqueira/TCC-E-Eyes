...
\end{equation}
 ...
 com $ \Delta T $ sendo metade do tempo recebido, pois se quer apenas o tempo entre emissão e reflexão, $ V = 0.034 cm/s$ representando a velocidade do som no ar, e $ \Delta S$ a distância em centímetros entre o sensor e obstáculo. Por fim, repassa o resultado para o módulo Bluetooth. Caso o valor da distância seja superior a 4 metros, limite de precisão do sensor, o valor não é repassado ao Bluetooth.
