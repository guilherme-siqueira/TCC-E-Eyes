...
Dentre as características que se pode obter de uma imagem, certamente a classificação de expressões faciais é a mais difícil de se obter. Segundo a Tabela \ref{bestPracticesTable}, as dimensões recomendadas para a detecção de face é a maior dentre todas as outras características. Como apresentado na Seção 4.1, o tempo de resposta cresce significativamente conforme a dimensão da imagem aumenta. 
